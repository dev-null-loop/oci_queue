variable "capabilities" {
  description = "The capability to add on the queue"
  type = list(object({
...
variable "display_name" {
  description = "The user-friendly name of the queue."
  type        = string
}
...
variable "purge_trigger" {
  description = "An optional property when incremented triggers Purge. Could be set to any integer value."
  type        = number
  default     = null
}

variable "purge_type" {
  description = "An optional value that specifies the purge behavior for the Queue. Could be set to NORMAL, DLQ or BOTH. If unset, the default value is NORMAL"
  type        = string
  default     = null
}
